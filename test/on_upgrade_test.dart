...
void main() {
  ...
  group('Upgrade execution', () {
    ...
    test('Execute none', () async {
      final wrapper = UpgradeWrapper(state: UpgradeState.upgrade, lastVersion: v200, currentVersion: v300);
    ...
    test('Execute all', () async {
      final wrapper = UpgradeWrapper(state: UpgradeState.upgrade, lastVersion: v005, currentVersion: v200);
    ...
    test('Execute all async, keep order', () async {
      ...
      final asyncFunctions = {
        v009: () => Future.delayed(const Duration(seconds: 2), () => asyncResult.add(v009)),
        v110: () => Future.delayed(const Duration(seconds: 1), () => asyncResult.add(v110)),
        v200: () => Future.delayed(const Duration(seconds: 0), () => asyncResult.add(v200)),
      };
    ...
    test('Execute some', () async {
      final wrapper = UpgradeWrapper(state: UpgradeState.upgrade, lastVersion: v009, currentVersion: v119);
    ...
    test('Execute none, no upgrade', () async {
      final wrapper = UpgradeWrapper(state: UpgradeState.noUpgrade, lastVersion: v009, currentVersion: v009);
